...
public class MailCreatorService {
    ...
    public String buildTrelloCardEmail(String message){
        ...
        context.setVariable("task_url","http://localhost:888/crud");
    ...
    public String buildDailyTaskInformatinMail(String message) {
        ...
        return templateEngine.process("mail/daily-task-information-mail", context);
    }
}
